...
class JeuTestMuseeService {
    ...
    def createJeuTest() {
        gest1 = new Gestionnaire(nom: 'Mairie de Toulouse - DGA Culture').save()
        gest2 = new Gestionnaire(nom: 'Association').save()
        gest3 = new Gestionnaire(nom: 'Autre institution publique').save()
        gest4 = new Gestionnaire(nom: 'Structure commerciale').save()

        adr1 = new Adresse(numero: '2',rue: 'RUE DES ARCHIVES',codePostal: '31500',ville: 'TOULOUSE' ).save()
        adr2 = new Adresse(numero: '5',rue: 'RUE SAINT PANTALEON',codePostal: '31000',ville: 'TOULOUSE' ).save()
        adr3 = new Adresse(numero: '69',rue: 'RUE PARGAMINIERES',codePostal: '31000',ville: 'TOULOUSE' ).save()
        adr4 = new Adresse(numero: '31',rue: 'RUE DE LA FONDERIE',codePostal: '31000',ville: 'TOULOUSE' ).save()
        adr5 = new Adresse(numero: '',rue: 'RUE MONTMORENCY',codePostal: '31200',ville: 'TOULOUSE' ).save()
        adr6 = new Adresse(numero: '2',rue: 'RUE VIGUERIE',codePostal: '31300',ville: 'TOULOUSE' ).save()
        adr7 = new Adresse(numero: '21',rue: 'RUE DE METZ',codePostal: '31000',ville: 'TOULOUSE' ).save()
        adr8 = new Adresse(numero: '2',rue: 'RUE TRIPIERE',codePostal: '31000',ville: 'TOULOUSE' ).save()
        adr9 = new Adresse(numero: '2',rue: 'RUE VIGUERIE',codePostal: '31300',ville: 'TOULOUSE' ).save()
        adr10 = new Adresse(numero: '7',rue: 'RUE DU MAY',codePostal: '31000',ville: 'TOULOUSE' ).save()
        adr11 = new Adresse(numero: '',rue: 'RUE DU JAPON',codePostal: '31400',ville: 'TOULOUSE' ).save()
        adr12 = new Adresse(numero: '13',rue: 'RUE DE LA PLEAU',codePostal: '31000',ville: 'TOULOUSE' ).save()
