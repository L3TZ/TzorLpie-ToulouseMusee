...
<div class="fieldcontain ${hasErrors(bean: museeInstance, field: 'demandevisites', 'error')} ">
	...
	<g:select name="demandevisites" from="${toulousemusee.DemandeVisite.list()}" multiple="multiple" optionKey="id" size="5" value="${museeInstance?.demandevisites*.id}" class="many-to-many"/>
